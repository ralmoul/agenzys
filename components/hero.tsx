  ...
  return (
    ...
    >
      ...
      <div className="text-balance relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-center text-3xl font-semibold tracking-tight text-gray-700 dark:text-neutral-300 md:text-7xl">
        <Balancer>
          <motion.h2>
            {"Automatisez votre agence immobilière, sans changer vos habitudes"
              .split(" ")
              .map((word, index) => (
                <motion.span
                  initial={{
      ...
      >
        Bénéficiez d'une automatisation sur-mesure, directement intégrée à vos logiciels préférés. Ne changez rien : vos outils deviennent instantanément plus intelligents.
      </motion.p>
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <Button
          ...
          as="button"
          variant="primary"
          className="hidden md:block w-fit px-6"
        >

    ...
    >
      <Header>
        <h2 className="font-sans text-bold text-xl text-center md:text-4xl w-fit mx-auto font-bold tracking-tight text-neutral-8000 dark:text-neutral-100 text-neutral-800">
          Votre agence, boostée par l'automatisation invisible
        </h2>
      </Header>
      <p className="max-w-lg text-sm text-neutral-600 text-center mx-auto mt-4 dark:text-neutral-400">
        Pourquoi se compliquer la vie ? Et si tout fonctionnait enfin… dans l'ombre ?
      </p>
      <div className="mt-20  grid cols-1 md:grid-cols-5 gap-4 md:auto-rows-[25rem] max-w-7xl mx-auto">
        <Card className="flex flex-col justify-between md:col-span-3">
          ...
          <CardContent className="h-48">
            <CardTitle>Marre de ressaisir les mêmes informations ?</CardTitle>
            <CardDescription>
              Vous perdez des leads, faute de relance ou de suivi ? Vos équipes râlent dès qu'il faut apprendre un nouvel outil ? Pourquoi se compliquer la vie ?
            </CardDescription>
          </CardContent>
        </Card>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-48">
            <CardTitle>Intégration 100% transparente</CardTitle>
            <CardDescription>
              Automatisation de vos tâches répétitives et suivis, sans aucun changement de workflow. Zéro friction : pas d'appli à installer, pas d'interface à apprendre.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
        ...
        <Card className="flex flex-col justify-between md:col-span-2">
          <CardContent className="h-56">
            ...
            <CardDescription>
              Génération automatique de leads, synchronisation instantanée, automatisation des rappels et reporting. Personnalisation totale
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <SkeletonTwo />
        ...
        <Card className="flex flex-col justify-between md:col-span-3">
          <CardContent className="h-48">
            ...
            <CardDescription>
              Diagnostic offert : on échange sur vos flux et outils actuels. Mapping & intégration sur-mesure : vous validez, nous déployons. Effet magique : vos habitudes restent
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
            <div className="w-full h-full p-4 rounded-lg bg-neutral-100 border border-neutral-200 dark:bg-neutral-800 dark:border-neutral-700 ml-6 mt-2">
...
const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "font-sans max-w-xs text-base font-normal tracking-tight mt-2 text-neutral-500 dark:text-neutral-400 line-clamp-4",
        className
      )}
    >
      {children}
